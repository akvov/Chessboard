...
-передвижение фигур
-ходы по очереди
-проверка и подсветка возможных ходов
-подсветка прошлого хода
-правильное определение возможных ходов - король не ставится под удар
-особые ходы - взятие на проходе, превращение пешки, рокировки короля
-определение мата и пата на доске

что бы хотелось ещё сделать
-отображение съеденных игроками фигур
-запись/отображение ходов согласно нотации 
-разворот доски
-проработать стили/анимации чтобы красивее выглядело
...

/**/

//распределение клеток на черные/белые
